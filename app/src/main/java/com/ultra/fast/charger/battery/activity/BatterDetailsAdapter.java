...
public class BatterDetailsAdapter extends ArrayAdapter<String> {
    ...
    public BatterDetailsAdapter(Activity activity, String[] strArr, String[] strArr2, Integer[] numArr) {
        super(activity, R.layout.layout_battery_details_item, strArr);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View inflate = this.f6254a.getLayoutInflater().inflate(R.layout.layout_battery_details_item, null, true);

...
public class BackDialog extends Dialog {
    ...
    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.layout_back_dialog, null);

        positiveButton = (TextView) mView.findViewById(R.id.tv_rate_star);
        negativeButton = (TextView) mView.findViewById(R.id.tv_exit);
